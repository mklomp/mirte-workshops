...
.. grid:: 1 2 2 2
   ...
   .. grid-item::
      ...
      aan. Daarna de groene. En daarna gaan ze knipperen. 
   ...
   .. grid-item::
      ...
      .. video:: /_static/mirte_boot_leds.mp4
         :width: 500
         :autoplay:
         :loop:
...
.. grid:: 1 2 2 2
   ...
   .. grid-item::
      ...
      gestart met de naam: Mirte-XXXXXX (waarbij XXXXXX de cijfers en getallen zijn die op je 
      doos staan).
