...
//TODO: soomething in this line. Get the precahes-files.json

/*
self.addEventListener('install', (event) => {
  event.waitUntil(
    // TODO: inlcude /en/ and /nl/
    fetch('/_static/precache-files.json')
